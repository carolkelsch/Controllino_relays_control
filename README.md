...
- **Optimized**: this mode was optimized for a specific functionality. It configures the 4 relays as 2 pairs. The relays **1**(D0) and **2**(D1) are activated to enable a motor to roll in a direction and the relays **3**(D2) and **4**(D3) enables the motor to roll in the oposite direction.
